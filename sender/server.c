...
int main()
{
  ...
  while(1)
  {
		...
		{	
		 ...
		 strcpy(site1.site_name,"www.youtube.com");
		 strcpy(site1.site_desc,"Online Video Sharing");
		 ...
		 stat1.info_port = 5432; 
  		 stat1.bit_rate = 320;
  		 strcpy(stat1.station_name,"Station1");
  		 
  		 /*Declaration of site info for station 2 */
  		 bzero(&site2,sizeof(site2));
  		 strcpy(site2.site_name,"www.youtube.com");
		 strcpy(site2.site_desc,"Online Video Sharing");
       ...
       stat2.bit_rate = 1050;
		 strcpy(stat2.station_name,"Station2");
